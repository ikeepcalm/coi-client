...
/**
 * Chained — a distorted humanoid wrapped in black bandages, straining to burst free through
 * protruding fur, fangs and bloodshot eyes under heavy iron chain rings.
 *
 ...
 */
public final class ChainedForm implements MythicalCreatureForm {
    ...
    public void render(AvatarRenderState state, PoseStack.Pose pose, VertexConsumer consumer) {
        ...
        for (int i = 0; i < burstCount; i++) {
            ...
            drawCube(pose, consumer, bx, by, bz, prSize, 0.38f, 0.2f, 0.1f, 0.92f, light);
            ...
            if (i % 2 == 0) {
                ...
                drawCube(pose, consumer, ex, by, ez, 0.022f, 0.85f, 0.2f, 0.2f, eyePulse, light);
