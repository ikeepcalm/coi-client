...
/**
 * Giant — a colossal armored humanoid lit by an impending-sunset glow bloom.
 *
 ...
 */
public final class GiantForm implements MythicalCreatureForm {
    ...
    public void render(AvatarRenderState state, PoseStack.Pose pose, VertexConsumer consumer) {
        ...
        for (int i = 0; i < runeCount; i++) {
            ...
            drawCube(pose, consumer, rx, currentY, rz, runeSize, rr, rg, rb, alpha, light);
        }
    }
}
