...
import dev.ua.ikeepcalm.coi.client.mixin.PlayerModelMixin;
 ...
 * vanilla player model. {@link dev.ua.ikeepcalm.coi.client.mixin.PlayerModelMixin} hides the player's
