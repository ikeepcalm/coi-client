...
/**
 * Door — a humanoid of layered translucent light-bubble shells, orbited by glowing bubbles
 * that each hold doors of light and a hidden eye.
 *
 ...
 */
public final class DoorForm implements MythicalCreatureForm {
    ...
    public void render(AvatarRenderState state, PoseStack.Pose pose, VertexConsumer consumer) {
        ...
        for (int b = 0; b < bubbleCount; b++) {
            ...
            drawCube(pose, consumer, bx, by, bz, bubbleSize, 0.4f, 0.7f, 1.0f, 0.17f, light);
            drawCube(pose, consumer, bx, by, bz, bubbleSize * 0.76f, 0.55f, 0.88f, 1.0f, 0.14f, light);
            ...
            drawCube(pose, consumer, bx, by, bz, eyeSize, 0.04f, 0.04f, 0.1f, 0.88f, light);
            drawCube(pose, consumer, bx, by, bz, eyeSize * 0.44f, 0.92f, 0.78f, 0.18f, 0.92f, light);
            ...
            for (int w = 0; w < 3; w++) {
                ...
                for (int s = 0; s < 4; s++) {
                    ...
                    drawCube(pose, consumer, sx, sy, sz2, sSize, 0.78f, 0.92f, 1.0f, 0.65f - s * 0.1f, light);
                }
            }
        }
    }
    ...
    private void drawLightBody(PoseStack.Pose pose, VertexConsumer consumer,
        ...
        drawInsetBox(pose, consumer, x1, y1, z1, x2, y2, z2, 0.04f, 0.58f, 0.84f, 1.0f, 0.16f, light);
    }
}
