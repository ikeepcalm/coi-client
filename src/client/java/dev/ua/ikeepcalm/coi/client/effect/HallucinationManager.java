...
import dev.ua.ikeepcalm.coi.client.effect.visual.EyesEffect;
import dev.ua.ikeepcalm.coi.client.effect.visual.GlitchEffect;
...
public class HallucinationManager {
    ...
    /**
     * Play the scheduled sounds that are due (e.g. individual footsteps).
     */
