...
/**
 * Fortune — a semi-transparent silhouette of fate incarnate at the centre of its own omens.
 *
 ...
 */
public final class FortuneForm implements MythicalCreatureForm {
    ...
    public void render(AvatarRenderState state, PoseStack.Pose pose, VertexConsumer consumer) {
        ...
        for (int i = 0; i < threadSegs; i++) {
            ...
            float thSize = 0.014f;
            drawCube(pose, consumer, tx, ty, tz, thSize, 1.0f, 0.86f, 0.2f, 0.82f, light);
        }
    }
}
