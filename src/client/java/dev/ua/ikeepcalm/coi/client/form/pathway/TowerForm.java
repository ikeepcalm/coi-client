...
/**
 * Tower — a humanoid pillar of blinding white-yellow knowledge-light, spiralled by swirling
 * symbols and text.
 *
 ...
 */
public final class TowerForm implements MythicalCreatureForm {
    ...
    public void render(AvatarRenderState state, PoseStack.Pose pose, VertexConsumer consumer) {
        ...
        for (int i = 0; i < symbolCount; i++) {
            ...
            drawCube(pose, consumer, sx, height, sz, symSize, r, g, b, alpha, light);
        }
    }
    ...
    private void drawLightPillar(PoseStack.Pose pose, VertexConsumer consumer,
        ...
        drawInsetBox(pose, consumer, x1, y1, z1, x2, y2, z2, 0.055f, 1.0f, 1.0f, 1.0f, 0.75f + pulse, light);
    }
}
