...
/**
 * Death — an upright bone skeleton with a feathered serpent coiled around it.
 *
 ...
 */
public final class DeathForm implements MythicalCreatureForm {
    ...
    public void render(AvatarRenderState state, PoseStack.Pose pose, VertexConsumer consumer) {
        ...
        for (int i = 0; i < segments; i++) {
            ...
            // Vertebra
            drawCube(pose, consumer, bx, segY, waveZ, boneSize, 0.91f, 0.91f, 0.84f, 0.94f, light);
            ...
            for (int g = 0; g < 3; g++) {
                ...
                drawCube(pose, consumer, gx, gy, gz, gasSize, 0.04f, 0.38f, 0.14f, 0.20f, light);
            }
        }
    }
}
