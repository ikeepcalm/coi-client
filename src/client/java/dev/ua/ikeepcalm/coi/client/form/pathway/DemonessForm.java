...
/**
 * Demoness — a female humanoid of dense gray fog, wrapped in spider silk and shot through
 * with plague spots.
 *
 ...
 */
public final class DemonessForm implements MythicalCreatureForm {
    ...
    public void render(AvatarRenderState state, PoseStack.Pose pose, VertexConsumer consumer) {
        ...
        for (int i = 0; i < threadSegments; i++) {
            ...
            float thS = 0.011f;
            drawCube(pose, consumer, tx, height, tz, thS, 0.95f, 0.95f, 1.0f, 0.72f, light);
        }
        ...
        for (int i = 0; i < spotCount; i++) {
            ...
            drawCube(pose, consumer, sx, sy, sz, spotSize, 0.18f, 0.02f, 0.22f, 0.78f, light);
            drawCube(pose, consumer, sx, sy, sz, spotSize * 0.48f, 0.35f, 0.0f, 0.46f, 0.92f, light);
        }
    }
