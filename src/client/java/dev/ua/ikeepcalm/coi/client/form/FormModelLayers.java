...
import dev.ua.ikeepcalm.coi.client.form.model.VisionaryLowerModel;
import dev.ua.ikeepcalm.coi.client.mixin.LivingEntityRendererMixin;
...
/**
 * Registration and placement of the baked models used by partial creature forms.
 *
 * <p>The placement constants below were tuned by eye against the live render and are documented
...
public class FormModelLayers {
    ...
    // hipRaise (LivingEntityRendererMixin) is an un-popped pushPose/translate at the top of submit(), so
