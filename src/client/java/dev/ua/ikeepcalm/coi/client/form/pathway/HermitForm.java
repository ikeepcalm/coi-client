...
/**
 * Hermit — a full-body tattered gray robe over a humanoid of infinite forbidden knowledge.
 *
 ...
 */
public final class HermitForm implements MythicalCreatureForm {
    ...
    public void render(AvatarRenderState state, PoseStack.Pose pose, VertexConsumer consumer) {
        ...
        for (int i = 0; i < streamCount; i++) {
            ...
            drawCube(pose, consumer, sx, scrollY, sz, symSize, r, g, b, 0.82f, light);
        }
        ...
        for (int i = 0; i < eyeCount; i++) {
            ...
            drawCube(pose, consumer, ex, ey, ez, eyeSize, 0.68f, 0.1f, 0.92f, alpha, light);
            drawCube(pose, consumer, ex, ey, ez, eyeSize * 0.48f, 1.0f, 0.82f, 1.0f, alpha, light);
        }
    }
}
