...
/**
 * Tyrant — a towering dark blue humanoid in deep-blue scales, ringed by hurricane winds,
 * trailing tentacles and struck by intermittent lightning.
 *
    ...
    public void render(AvatarRenderState state, PoseStack.Pose pose, VertexConsumer consumer) {
        ...
        for (int t = 0; t < tentacleCount; t++) {
            ...
            for (int s = 0; s < segments; s++) {
                ...
                drawCube(pose, consumer, tx, ty, tz, tSize, 0.02f, 0.1f, 0.34f, 0.78f - s * 0.045f, light);
            }
        }
        ...
        if (lRand.nextInt(3) == 0) {
            ...
            for (int l = 0; l < 7; l++) {
                ...
                drawStrut(pose, consumer, curX, curY, curZ, nextX, nextY, nextZ,
                        0.022f, 0.72f, 0.92f, 1.0f, 0.94f, light);
                curX = nextX;
                curY = nextY;
                curZ = nextZ;
            }
