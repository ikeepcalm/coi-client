package dev.ua.ikeepcalm.coi.client.form.model;

import dev.ua.ikeepcalm.coi.client.form.FormModel;
...
public class VisionaryLowerModel extends Model<AvatarRenderState> implements FormModel {
    ...
    public Matrix4f carrierDelta() {
        return FormModel.carrierDelta(WHole, BODY);
    }
}
