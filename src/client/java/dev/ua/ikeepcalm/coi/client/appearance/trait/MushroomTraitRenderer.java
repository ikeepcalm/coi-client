...
/**
 * Draws the {@code mushroom} appearance trait: red-capped mushrooms growing from the head, swept as
 * tapering tubes by {@link TraitGeometry} against a blank white texture so the vertex colours alone
