...
/**
 * Paragon — an industrial machine humanoid whose body regions are gear and piston assemblies,
 * wired together by glowing circuit pathways.
 *
 ...
 */
public final class ParagonForm implements MythicalCreatureForm {
    ...
    private void drawBronzePillar(PoseStack.Pose pose, VertexConsumer consumer,
        ...
        drawInsetBox(pose, consumer, x1, y1, z1, x2, y2, z2, 0.04f, 0.50f, 0.28f, 0.08f, 0.92f, light);
    }
    ...
    private void drawGear(PoseStack.Pose pose, VertexConsumer consumer,
        ...
        drawCube(pose, consumer, cx, cy, cz, hubSize, 0.5f, 0.3f, 0.1f, 0.95f, light);
