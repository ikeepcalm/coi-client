...
/**
 * Emperor — a towering shadow-infused imperial robe over a full humanoid frame.
 *
 ...
 */
public final class EmperorForm implements MythicalCreatureForm {
    ...
    public void render(AvatarRenderState state, PoseStack.Pose pose, VertexConsumer consumer) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            drawCube(pose, consumer, gx, gy, gz, gSize, 0.42f, 0.05f, 0.62f, 0.62f, light);
        }
    }
}
