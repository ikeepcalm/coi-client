...
/**
 * Draws the {@code horns} appearance trait: a pair of dark, ridged horns curving back from the
 * temples, swept as tapering tubes by {@link TraitGeometry} against a blank white texture so the
 * vertex colours alone decide how they look.
 */
