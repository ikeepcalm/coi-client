...
/**
 * Error — a body of stacked, independently counter-rotating clock dials (the Worms of Time),
 * ringed by faint doors of light.
 *
 ...
 */
public final class ErrorForm implements MythicalCreatureForm {
    ...
    private void drawClockDial(PoseStack.Pose pose, VertexConsumer consumer,
        ...
        Random rand = new java.util.Random(seed * 9991L);

        // Central hub
        float hubSize = 0.055f;
        drawCube(pose, consumer, cx, cy, cz, hubSize, 0.32f, 0.62f, 0.44f, 0.82f, light);
        ...
        for (int b = 0; b < bezelSegs; b++) {
            ...
            float bSize = 0.025f;
            drawCube(pose, consumer, bx, by, cz, bSize, 0.22f, 0.52f, 0.36f, 0.65f, light);
        }
        ...
        drawStrut(pose, consumer, cx, cy, cz, hx, hy, cz, 0.014f, 0.3f, 0.6f, 0.4f, 0.87f, light);
        ...
        drawStrut(pose, consumer, cx, cy, cz, mx, my, cz, 0.010f, 0.2f, 0.5f, 0.32f, 0.87f, light);
        ...
        for (int t = 0; t < ticks; t++) {
            ...
            drawCube(pose, consumer, tx, ty, cz, tickSize, tr, tg, tb, 0.62f, light);
        }
    }
}
