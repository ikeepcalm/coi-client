...
/**
 * Justiciar — an armored judge in gold pauldrons, holding a giant balance scale of golden
 * light inside rings of absolute order.
 *
 ...
 */
public final class JusticiarForm implements MythicalCreatureForm {

    private static final float BEAM_THICKNESS = 0.022f;
    ...
    /**
     * The scale's tilting crossbeam, spanning the two suspension points.
     */
    private void drawBeam(PoseStack.Pose entry, VertexConsumer consumer,
                          float x1, float y1, float z1, float x2, float y2, float z2,
                          float r, float g, float b, int light) {
        drawStrut(entry, consumer, x1, y1, z1, x2, y2, z2, BEAM_THICKNESS, r, g, b, 0.92f, light);
    }
}
