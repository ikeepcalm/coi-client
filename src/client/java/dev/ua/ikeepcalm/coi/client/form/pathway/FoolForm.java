...
/**
 * Fool — a translucent purple spirit silhouette threaded through by orbiting Worms of Spirit.
 *
 ...
 */
public final class FoolForm implements MythicalCreatureForm {
    ...
    public void render(AvatarRenderState state, PoseStack.Pose pose, VertexConsumer consumer) {
        ...
        for (int i = 0; i < wormCount; i++) {
            Random rand = new java.util.Random(i * 12345L);
            ...
            for (int s = 0; s < segments; s++) {
                ...
                drawCube(pose, consumer, sx, sy, sz, size, wr, wg, wb, wa, light);
            }
        }
    }
}
