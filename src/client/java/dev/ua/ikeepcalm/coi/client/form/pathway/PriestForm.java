...
/**
 * Priest — a towering crimson-flame warlord in layered fire, crowned and flying war banners.
 *
...
public class PriestForm implements MythicalCreatureForm {
    ...
    public void render(AvatarRenderState state, PoseStack.Pose pose, VertexConsumer consumer) {
        ...
        for (int i = 0; i < sparkCount; i++) {
            ...
            drawCube(pose, consumer, sx, sy, sz, sparkSize, 1.0f, 0.7f + rand.nextFloat() * 0.3f, 0.1f, 0.82f * (1.0f - sy / 2.75f), light);
        }
    }
    ...
    private void drawFireColumn(PoseStack.Pose pose, VertexConsumer consumer,
        ...
        drawInsetBox(pose, consumer, x1, y1, z1, x2, y2, z2, 0.05f, 1.0f, 0.45f, 0.0f, 0.38f, light);
    }
}
