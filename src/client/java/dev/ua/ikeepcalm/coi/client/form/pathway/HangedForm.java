...
/**
 * Hanged — a massive pitch-black shadow silhouette bound in grotesque shadow chains.
 *
 ...
 */
public final class HangedForm implements MythicalCreatureForm {
    ...
    public void render(AvatarRenderState state, PoseStack.Pose pose, VertexConsumer consumer) {
        ...
        for (int i = 0; i < 18; i++) {
            ...
            for (int l = 0; l < links; l++) {
                ...
                drawCube(pose, consumer, cx, cy, cz, chainSize, 0.12f, 0.12f, 0.13f, 0.84f, light);
            }
        }
        ...
        for (int i = 0; i < particleCount; i++) {
            ...
            drawCube(pose, consumer, px, py, pz, pSize, pr, pg, pb, 0.75f, light);
        }
    }
}
